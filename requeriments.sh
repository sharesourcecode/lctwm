...
# /update script and dependencies
	...
	echo -e "👉 Please wait...☕👴"
_sync () {
	curl https://github.com/sharesourcecode/lctwm/raw/master/LICENSE -O -L &> /dev/null &
	curl https://github.com/sharesourcecode/lctwm/raw/master/PLAY.sh -O -L &> /dev/null &
	curl https://github.com/sharesourcecode/lctwm/raw/master/README.md -O -L &> /dev/null &
	curl https://github.com/sharesourcecode/lctwm/raw/master/altars.sh -O -L &> /dev/null &
	curl https://github.com/sharesourcecode/lctwm/raw/master/arena.sh -O -L &> /dev/null &
	curl https://github.com/sharesourcecode/lctwm/raw/master/campaign.sh -O -L &> /dev/null &
	curl https://github.com/sharesourcecode/lctwm/raw/master/career.sh -O -L &> /dev/null &
	curl https://github.com/sharesourcecode/lctwm/raw/master/cfg1 -O -L &> /dev/null &
	curl https://github.com/sharesourcecode/lctwm/raw/master/clancoliseum.sh -O -L &> /dev/null &
	curl https://github.com/sharesourcecode/lctwm/raw/master/clandungeon.sh -O -L &> /dev/null &
	curl https://github.com/sharesourcecode/lctwm/raw/master/clanfight.sh -O -L &> /dev/null &
	curl https://github.com/sharesourcecode/lctwm/raw/master/clanid.sh -O -L &> /dev/null &
	curl https://github.com/sharesourcecode/lctwm/raw/master/coliseum.sh -O -L &> /dev/null &
	curl https://github.com/sharesourcecode/lctwm/raw/master/crono.sh -O -L &> /dev/null &
	curl https://github.com/sharesourcecode/lctwm/raw/master/king.sh -O -L &> /dev/null &
	curl https://github.com/sharesourcecode/lctwm/raw/master/loginlogoff.sh -O -L &> /dev/null &
	curl https://github.com/sharesourcecode/lctwm/raw/master/play.sh -O -L &> /dev/null &
	curl https://github.com/sharesourcecode/lctwm/raw/master/requeriments.sh -O -L &> /dev/null &
	curl https://github.com/sharesourcecode/lctwm/raw/master/torstop.sh -O -L &> /dev/null &
	curl https://github.com/sharesourcecode/lctwm/raw/master/trade.sh -O -L &> /dev/null &
	curl https://github.com/sharesourcecode/lctwm/raw/master/undying.sh -O -L &> /dev/null && \
...
#	echo -e '"Mozilla/5.0 (Linux; Android 9.0.0; SM-G955U) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/78.0.3904.96 Mobile Safari/537.36"' >.ua
	dos2unix ~/lctwm/.ua &> /dev/null
	cp ~/lctwm/.ua ~/.tmp/.ua &> /dev/null
# /servers
